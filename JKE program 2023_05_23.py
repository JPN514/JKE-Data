...
def df_to_sheet():
    with pd.ExcelWriter("TIPS_Experimental_V3.xlsx") as writer:
...
def df_to_mySQL(df):
    ...
    #Creates the database called "JKE_DATA" using the SQL query below       
    #create_database_query = "CREATE DATABASE JKE_DATA;"        #we can comment out this once the database has been created successfully!
    ...
    db_connection = create_db_connection("localhost","root","a","JKE_DATA")
